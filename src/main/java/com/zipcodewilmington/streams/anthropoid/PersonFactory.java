...
public final class PersonFactory {
    ...
    public Person[] createPersonArray(int arrayLength) {
        Person[] res = new Person[arrayLength];
        Arrays.setAll(res, n -> this.createRandomPerson());
        return res;
    }
    ...
    public Stream<Person> createPersonStream(int streamCount) {
        Stream<Person> res = Stream.generate(this::createRandomPerson).limit(streamCount);
        return res;
    }
}
